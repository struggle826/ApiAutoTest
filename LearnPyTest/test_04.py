...
# 测试数据
case_data = [("15229807878","123456","投资人","手机号码已被注册","20110",0),
             ("152","8888","借款人","密码长度必须为6~18","20108",0)]
...
def test_withdraw(mobile,amount):
    url = "http://192.168.150.52:8089/futureloan/mvc/api/member/withdraw" #recharge充值
